        ...
        <div className="w-full bg-white mt-4 rounded-2xl p-4 select-none">
          ...
          <div className="relative flex justify-between items-center mb-8">
            {!openRename && !openEditMenu && (
              ...
              >
                {formData.projects.title || "PROJECTS"}
              </span>
            )}
          ...
          {formData.projects.items.map((item) => (
            ...
            >
              <div className="w-full flex flex-col gap-y-2 select-none text-sm text-[#7D8588] mt-1 bg-transparent outline-none py-3 pl-3 pr-12 border-[1px] border-[#AFB4B5] transition-all duration-300 rounded">
                ...
                <span>
                  {item.shortDescription || "Short summary of your work"}
                </span>
              </div>
              <div
                onClick={(event) => {
          ...
          >
            ...
            <div className="w-full">
              <div
                onClick={() => {
                  if (editingItemId) {
                    removeSectionItem("projects", editingItemId);
                  }
                  setopenMobileEdit(false);
                }}
                className="w-full p-6 text-[#505A5D] flex items-center gap-2 border-b-[1px] border-b-[#E4E4E4] pb-4"
        ...
        <form className="w-full px-6 bg-[#FAFBFD]">
            ...
            <input
              ...
              onChange={(event) => {
                if (editingItemId) {
                  ...
                  handleSectionChange("projects", "name", event.target.value);
                }
              }}
          ...
          <div className="w-full mt-2">
            ...
            <div className="flex items-center gap-x-2">
              <DatePicker
                selected={formData.projects.date}
                // value={value.date}
                // onChange={(date) => onChange("date", date)}
                value={
                  editingItemId
                ...
                onChange={(date) => {
                  if (editingItemId) {
                    ...
                    handleSectionChange("projects", "date", date);
                  }
                }}
            ...
            <input
              value={
                editingItemId
                  ...
                  : formData.projects.shortDescription
              }
              onChange={(event) => {
                if (editingItemId) {
                  handleSectionChange(
