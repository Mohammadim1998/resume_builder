...
const Projects = ({ value, onChange,removeSection }) => {
      ...
      {!isMobile ? (
        <div className="relative group w-full h-fit select-none">
          ...
          <div className="flex items-center mt-2">
           ...
           <div className="absolute -top-4 right-0 w-8 h-8 cursor-pointer hidden group-hover:flex justify-center items-center rounded bg-white border-[1px] border-gray-600 border-opacity-40" onClick={() => removeSection("projects")}><FaRegTrashAlt /></div>
        </div>
      ) : (
        <>
          ...
          {openMobileEdit && (
            <div className="w-full h-full fixed select-none top-0 left-0 right-0 bottom-0 px-8 bg-opacity-90 bg-[#59566A] z-40">
              <div className="pb-2 bg-white rounded-md absolute bottom-10 left-8 right-8">
                ...
                <div className="w-full">
                  <div onClick={() => removeSection("projects")} className="w-full p-6 text-[#505A5D] flex items-center gap-2 border-b-[1px] border-b-[#E4E4E4] pb-4">
                    <div className="text-2xl">
                      <FaRegTrashAlt />
                    </div>
