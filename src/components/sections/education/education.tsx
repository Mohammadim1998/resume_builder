  ...
  return (
    <>
      {!isMobile ? (
        ...
        <>
          <div className="w-full bg-white mt-4 select-none rounded-2xl p-4">
          ...
          {openMobileEdit && (
            <div className="w-full h-full select-none fixed top-0 left-0 right-0 bottom-0 px-8 bg-opacity-90 bg-[#59566A] z-40">
              <div className="pb-2 bg-white rounded-md absolute bottom-10 left-8 right-8">
                ...
                <div className="w-full">
                  <div onClick={() => removeSection("education")} className="w-full p-6 text-[#505A5D] flex items-center gap-2 border-b-[1px] border-b-[#E4E4E4] pb-4">
                    <div className="text-2xl">
                      <FaRegTrashAlt />
                    </div>
