    ...
    <>
      {!isMobile ? (
            ...
            {formData.skills.items.map((item) => (
              ...
              >
                <input
                  ...
                  type="text"
                  className="w-16 text-md border-b-[1px] border-b-gray-400 h-5 bg-transparent outline-none px-2 focus:border-[1px] focus:border-green-400 transition-all duration-300 rounded"
                  placeholder="Skill"
                />
        ...
        <div className="w-full bg-white mt-4 rounded-2xl p-4 select-none">
          ...
          {formData.skills.items.map((item) => (
            ...
            >
              <div className="w-full flex select-none text-sm text-[#7D8588] mt-1 bg-transparent outline-none py-3 pl-3 pr-12 border-[1px] border-[#AFB4B5] transition-all duration-300 rounded">
                <span className="font-semibold">
                  {item.skill || "Your Skill"}
                </span>
              </div>
              <div
                onClick={(event) => {
          ...
          >
            ...
            <div className="w-full">
              <div
                onClick={() => {
                  if (editingItemId) {
                    removeSectionItem("skills", editingItemId);
                  }
                  setopenMobileEdit(false);
                }}
                className="w-full p-6 text-[#505A5D] flex items-center gap-2 border-b-[1px] border-b-[#E4E4E4] pb-4"
      ...
      >
        ...
        <form className="w-full px-6 bg-[#FAFBFD]">
          <span className="mb-3 block text-[#75696C] font-medium">SKILLS</span>
          <div className="w-full">
            <span className="text-[#75696C] font-medium mb-2 block">Skill</span>
            <input
              value={
                editingItemId
                  ? formData.skills.items.find(
